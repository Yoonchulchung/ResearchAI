        ...
        <div className={`px-6 py-4 shrink-0 border-b ${selected ? "hidden md:block" : ""} ${isGlass ? (isDark ? "border-white/20" : "border-black/5") : isDark ? "bg-slate-800 border-slate-700" : "bg-white border-slate-300"}`}>
          <div className="flex flex-wrap items-center gap-3">
            ...
            <select
              ...
              className={`w-auto md:w-48 text-xs md:text-sm px-2 md:px-3 py-1.5 md:py-2 border rounded-sm focus:outline-none focus:ring-1 focus:ring-blue-600 appearance-none shrink-0 ${isDark ? "bg-slate-900 border-slate-600 text-slate-200" : "bg-white border-slate-400 text-slate-800"}`}
