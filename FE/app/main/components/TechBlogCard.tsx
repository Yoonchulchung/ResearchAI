  ...
  return (
    <div className="glass-panel rounded-2xl p-5">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/tech-blogs" className="text-2xs font-semibold text-slate-400 hover:text-indigo-500 transition-colors">
          전체 보기
        </Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-2 py-6 text-center">
          ...
          <Link href="/tech-blogs" className="text-xs font-semibold text-indigo-500 hover:text-indigo-600">
            페이지에서 다시 시도
          </Link>
        </div>
      ) : posts.length === 0 ? (
