      ...
      <div className="bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-2xl mx-4 flex flex-col max-h-[90vh]">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={10}
              className="w-full text-sm text-slate-700 bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-indigo-300/50 focus:border-indigo-300 resize-none placeholder-slate-300 leading-relaxed"
            />
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-slate-100">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 text-xs font-semibold bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
            {saving ? (
