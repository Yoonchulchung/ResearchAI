      ...
      <div className="bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-sm mx-4" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center justify-end gap-2 px-5 py-3 border-t border-slate-100">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-1.5 text-xs font-semibold bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-40 transition-colors"
          >
            {saving && (
