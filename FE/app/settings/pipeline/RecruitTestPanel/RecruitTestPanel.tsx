    ...
    <div className="space-y-5">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-5 space-y-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 text-sm font-medium px-4 py-2 rounded-xl bg-indigo-600 text-white hover:bg-indigo-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
      ...
      {logs.length > 0 && (
        <div className="bg-slate-900 rounded-2xl p-4">
          <p className="text-xs font-semibold text-slate-400 mb-2">로그</p>
