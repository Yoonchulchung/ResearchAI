...
@Module({
  imports: [TypeOrmModule.forFeature([ResearchRecruitEntity, LightResearchEntity, SearchListEntity]), forwardRef(() => RecruitModule), forwardRef(() => AiModule), forwardRef(() => SessionsModule), forwardRef(() => QueueModule)],
