 ...
 *
 * 사용 예:
 *   import { BASIC_TOOLS, executeOllamaTool } from 'src/ai/infrastructure/provider/ollama/ollama-tools';
 *
...
import type { OllamaTool } from 'src/ai/infrastructure/provider/ollama/ollama.ai';
