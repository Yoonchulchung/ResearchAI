...
export const DEFAULT_AI_MODEL = () =>
  process.env.DEFAULT_AI_MODEL ?? 'gemini-2.0-flash-lite';
export const DEFAULT_GOOGLE_API_KEY = () =>
  process.env.DEFAULT_GOOGLE_API_KEY ?? '';
export const DEFAULT_GROQ_API_KEY = () =>
  process.env.DEFAULT_GROQ_API_KEY ?? '';
export const DEFAULT_GROQ_MODEL = () =>
  process.env.DEFAULT_GROQ_MODEL ?? 'llama-3.3-70b-versatile';
