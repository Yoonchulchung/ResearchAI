...
import { AiLeaderboardModule } from 'src/news/ai-leaderboard.module';
...
@Module({
  ...
  providers: [
    ...
    NewsProviderService,
    NewsSummaryService,
    NewsSummaryGeneratorService,
    NewsHistoricalCollectorService,
    NewsHistoricalCollectorImplService,
  ],
  exports: [NewsService, NewsHistoricalCollectorService],
})
