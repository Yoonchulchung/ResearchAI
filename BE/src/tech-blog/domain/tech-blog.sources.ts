import type { TechBlogSource } from './tech-blog.types';
...
export const TECH_BLOG_SOURCES: TechBlogSource[] = [
  ...
  { id: 'hyundai-autoever', name: 'Hyundai AutoEver Blog', url: 'https://www.hyundai-autoever.com/kor/about/pr/blog/list.do?', category: '모빌리티/로컬' },
